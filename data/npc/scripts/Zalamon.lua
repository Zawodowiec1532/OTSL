...
function creatureSayCallback(cid, type, msg)
	...
	-------------------- MISSION 2 ----------------
		...
		elseif (getPlayerStorageValue(cid,42830) == 2 and getPlayerStorageValue(cid,storageWrath) == 5 and getPlayerStorageValue(cid,12288) == 1) then
			if(msgcontains(msg, 'mission')) then
				npcHandler:say({'Now we need to get clozzer to zze {emperor} himzzelf. A hive of beezz would defend zzeir queen wizz zzeir lives in cazze an enemy gained entranzze. Zzizz makezz a formidable defenzze line, nearly inviolable. ...','But a zztranger directly in zze midzzt of zze hive will be acczzepted - after all it izz not pozzible to overcome zzuch a formidable defenzze which izz nearly inviolable, or izz it? Ha. ...','Now zzat you overcame zzeir linezz of defenzze at zze {great gate}, you only need to find a way to enter zzeir home. ...','Head zztraight to zze entranzze of zze zzity. If you can convinzze zze guardzz to let you enter zze zzity, you should be able to reach our contact zzere wizz eazze. ...','We have alzzo forged zome paperzz for you and zzent zzem to zze zzity. Your victory in zze arena iz well known in our land. Wizz zze help of zzezze paperzz you will pretend zzat zzome of zze higher officialzz want to talk to you about your battle. ...','Zzizz way you will be able to enter zze zzity of zze dragon emperor and meet our contact zzere in zze imperial offizze. He will give you zze next inzztructionzz.'}, cid)
