local keywordHandler = KeywordHandler:new()
	...
	local travelNode = keywordHandler:addKeyword({'thais'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to sail to Thais for 0 gold coins?'})
        ...
        keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can take you to Carlin, Ab\'dendriel, Venore, Edron, Ankrahmun, Port Hope, Thais, Liberty Bay, Svargrond, Liberty Bay and Yalahar.'})
