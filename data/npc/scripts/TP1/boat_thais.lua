local keywordHandler = KeywordHandler:new()
	...
	local travelNode = keywordHandler:addKeyword({'gengia'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to sail to Gengia for 0 gold coins?'})
        ...
        keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can take you to Carlin, Ab\'dendriel, Venore, Edron, Ankrahmun, Port Hope, Thais, Liberty Bay, Svargrond, Liberty Bay and Yalahar.'})
        keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I am the captain of this ship.'})
        keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can take you to Carlin, Ab\'dendriel, Venore, Edron, Ankrahmun, Port Hope, Gengia, Liberty Bay, Svargrond, Liberty Bay and Yalahar.'})
