local keywordHandler = KeywordHandler:new()
        ...
        local travelNode = keywordHandler:addKeyword({'banuta'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want go to the Banuta?'})
        ...
        keywordHandler:addKeyword({'transport'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can take you to the Banuta!'})
