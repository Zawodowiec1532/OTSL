    ...
    monthlyFragsToBanishment = 4000
	
	dailyFragsToBanishment = 14
	weeklyFragsToBanishment = 28
	monthlyFragsToBanishment = 47
	...
	maxPlayers = 900
	motd = "Welcome to the OTSL!"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = true
	allowClones = false
	serverName = "OTSL by Leon Zawodowiec"
	loginMessage = "Welcome to the OTSL!"
